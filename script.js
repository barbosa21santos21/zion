...
function calcularInvestimento() {
    ...
    // Alterado para mínimo de 5000
    if (!valorInvestimento || valorInvestimento < 5000) {
        alert('Por favor, insira um valor de investimento válido (mínimo R$ 5.000)');
        return;
    }
...
// Função para validação em tempo real dos inputs (somente formata, sem cálculo automático)
